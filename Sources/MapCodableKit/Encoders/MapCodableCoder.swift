...
open class MapEncodableEncoder<T: MapEncodable>: MapEncoder {
    ...
    open func toMap(value: T) throws -> [String: Any?]? {
        return try value.json()
    }
}

/// This object transforms a json value to a MapDecodable object.
open class MapDecodableDecoder<T: MapDecodable>: MapDecoder {
    ...
    open func fromMap(value: [String: Any?]) throws -> T? {
